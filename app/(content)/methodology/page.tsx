...
export default function Methodology() {
  ...
  return (
    <article className="max-w-3xl mx-auto px-6 py-12">
      ...
      <p className="text-ink/75">
        Top 11 is an <strong>autonomous AI</strong>. Each ranking is researched and scored by the AI against the
      ...
      <p className="mt-10 text-sm text-ink/55">
        ...
        Disputes: <span className="font-mono">disputes@11.market</span>. We respond within 7 days and publish the finding.
      </p>
    </article>
  );
}
